...
Revision ID: a3a2500b8552
Revises: 
Create Date: 2025-04-22 23:25:22.923397
...
def upgrade() -> None:
    ...
    op.create_table('lesson_sentence',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('lesson_id', sa.Integer(), nullable=False),
    sa.Column('english', sa.Text(), nullable=False),
    sa.Column('chinese', sa.Text(), nullable=False),
    sa.Column('audio_url', sa.String(length=500), nullable=True),
    sa.Column('audio_start', sa.Integer(), nullable=True),
    sa.Column('audio_end', sa.Integer(), nullable=True),
    ...
    sa.Column('file_name', sa.String(length=800), nullable=True),
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('deleted', sa.Integer(), nullable=True),
    sa.Column('sequence', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('type', sa.Integer(), nullable=True, comment='类型（0: 单词, 1: 句子,2.背词计划用了, 3:真正的单词拼写）'),
    sa.Column('continuous_days', sa.Integer(), nullable=True, comment='连续完成天数'),
    sa.Column('points', sa.Integer(), nullable=True, comment='积分'),
    sa.Column('speak_count', sa.Integer(), nullable=True, comment='开口次数'),
    sa.Column('create_time', sa.DateTime(), nullable=True, comment='创建时间'),
    sa.Column('update_time', sa.DateTime(), nullable=True, comment='更新时间'),
    sa.Column('progress_data', sa.Text(), nullable=True, comment='存储类似 study_progress_reports 表的数据'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('book_id', sa.String(length=50), nullable=False, comment='书籍ID'),
    sa.Column('lesson_id', sa.Integer(), nullable=True, comment='课程ID'),
    sa.Column('content_id', sa.Integer(), nullable=False, comment='内容ID（单词ID或句子ID等）'),
    sa.Column('content', sa.String(length=255), nullable=False, comment='学习内容（单词或句子）'),
    sa.Column('content_type', sa.Integer(), nullable=False, comment='类型（0: 单词发音, 1: 单词读, 2: 单词写, 3: 单独拼写按钮进去的那边提交, 4:句子）'),
    sa.Column('error_count', sa.Integer(), nullable=True, comment='错误次数（仅对单词的读和写有效）'),
    sa.Column('points', sa.Integer(), nullable=True, comment='积分'),
    sa.Column('create_time', sa.DateTime(), nullable=True, comment='创建时间'),
    sa.Column('update_time', sa.DateTime(), nullable=True, comment='更新时间'),
    sa.Column('json_data', sa.Text(), nullable=True, comment='TEXT 数据 的评分数据'),
    sa.Column('voice_file', sa.String(length=300), nullable=True, comment='语音文件路径或 URL'),
    sa.Column('chinese', sa.String(length=300), nullable=True, comment='中文翻译'),
    sa.Column('audio_url', sa.String(length=300), nullable=True, comment='音频文件路径或 URL'),
    sa.PrimaryKeyConstraint('id')
    )
