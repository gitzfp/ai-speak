  ...
  >
    <view class="message-grammat-container">
      ...
      <view v-if="!wordDetailShow" class="tab-box">
        <view
          @tap="handleActive('grammar')"
          class="tab-item"
          :class="{ active: activeView === 'grammar' }"
        >
          语法
        </view>
        <view
          @tap="handleActive('pronunciation')"
          class="tab-item"
      ...
      <!-- 语法评估 -->
      <MessageGrammar
        v-if="activeView === 'grammar' && !wordDetailShow"
        class="grammar-box"
      ...
      <!-- 发音评估 -->
      <MessagePronunciation
        v-if="activeView === 'pronunciation' && !wordDetailShow"
        :message-id="messageId"
        :session-id="sessionId"
