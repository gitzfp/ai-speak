		...
		<view class="mine-content">
			...
			<view class="profile-box">
				<view v-if="accountInfo.account_id.indexOf('visitor') === 0" class="profile" @tap="hangleLogin">
					<image class="profile-avatar" src="https://api.zfpai.top/static/default-account-avatar.png" />
			...
			<view class="setting">
				<!-- <view class="setting-card" @tap="goSetting">
					<image class="setting-card-logo" src="https://api.zfpai.top/static/setting.png" />
				...
				<view class="setting-card" @tap="goFeedback">
					<image class="setting-card-logo" src="https://api.zfpai.top/static/feedback.png" />
					<text class="setting-card-title">反馈</text>
				</view>
				<view class="setting-card" @tap="goContact">
					<image class="setting-card-logo" src="https://api.zfpai.top/static/concat.png" />
				...
				<view v-if="accountInfo.account_id.indexOf('visitor') < 0" class="logout-box" @tap="hangleLogout">
					<!-- <image class="setting-card-logo" src="https://api.zfpai.top/static/default-account-avatar.png" /> -->
